<template>
    <div>
      ...
      <div v-else>
        <p>Niciun post nu a fost creat</p>
      </div>
    ...
    <div>
        ...
        <select v-model="tag">
            ...
            <option value="flame" Flame>Flame</option>
            <option value="recommendation" Recommendation>recommendation</option>
        </select>
    ...
    export default {
        ...
        methods: {
            submitFormHandler(event) {
                ...
                //trimitem obiectul nou la backend
            ...
            deleteHandler(event){
                console.log(event.itemId)
                myaxios.post(`/blog/${event.itemId}`).then((response)=> {
                    console.log(response.data.blogs)
                    this.blogList = response.data.blogs
                })
            },
